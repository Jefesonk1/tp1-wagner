...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.widget_blue.setGeometry(QtCore.QRect(640, 10, 110, 60))
        ...
        self.widget_yellow.setGeometry(QtCore.QRect(760, 10, 110, 60))
        ...
        self.widget_magenta.setGeometry(QtCore.QRect(880, 10, 110, 60))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("resources/icons/plus.png"),
        ...
        icon1.addPixmap(QtGui.QPixmap(
            "resources/icons/rotate-left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resources/icons/up-arrow.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("resources/icons/home.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("resources/icons/zoom-in.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("resources/icons/zoom-out.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        #     0, _translate("MainWindow", "p1"))
        # self.treeWidget.topLevelItem(0).setText(
        #     1, _translate("MainWindow", "Point"))
        # self.treeWidget.topLevelItem(0).setText(
        #     2, _translate("MainWindow", "(2.0, 3.0)"))
        # self.treeWidget.topLevelItem(1).setText(
        #     0, _translate("MainWindow", "p2"))
        # self.treeWidget.topLevelItem(1).setText(
        #     1, _translate("MainWindow", "Point"))
        # self.treeWidget.topLevelItem(1).setText(
        #     2, _translate("MainWindow", "(3.0, 5.0)"))
    ...
    def newWinCoordinates(self, operation):
        ...
        #xmax, ymax = coord[1][0], coord[1][1]
        transladeToOriginMIN = wt.translade(-xmin, -ymin)
        #print(wt.rotate(math.radians(theta)))
        transladeToOriginalPositionMIN = wt.translade(xmin, ymin)
        rotateCoord = wt.rotate(math.radians(theta))
        transformationMatrix =  transladeToOriginalPositionMIN @ (rotateCoord @ transladeToOriginMIN)

        # transladeToOriginMAX = wt.translade(-xmax, -ymax)
        # transladeToOriginalPositionMAX = wt.translade(xmax, ymax)
        # rotateCoord = wt.rotate(theta)
        # matrixMAX = transladeToOriginMAX @ rotateCoord @ transladeToOriginalPositionMAX
        #print("matrixMAX",matrixMAX)
        if operation == 'rotate':
            xwMin, ywMin = self.calcular(
                *coord[0], transformationMatrix)
    ...
    def fillDrawerWidget(self, window: Window, viewport: Viewport, points: Point, lines: Line, polygons: Polygon):
        ...
        self.fillObjectsList(polygons)
        self.fillObjectsList(lines)
        self.fillObjectsList(points)
    ...
    def undoAddOnHistory(self):
        #self.decideCounterOperation(self.history[-1])
        self.history.pop()
        self.listWidget.takeItem(self.listWidget.count()-1)

    # def decideCounterOperation(self, object):
    #     operation, direction, value = object
    #     #print(operation, direction, value)
    #     if operation == 'Translation':
    #         if direction == 'Up':
    #             print('up')
    #             self.window.addTranslation(0, int(-value))
    #             a = self.window.getTranslation()
    #             x = str(a[0])
    #             y = str(a[1])
    #             self.updateLabelTranslation(x, y)
    ...
    #         if direction == 'Left':
    #             print('left')
    #             self.window.addTranslation(int(value), 0)
    #             a = self.window.getTranslation()
    #             x = str(a[0])
    #             y = str(a[1])
    #             self.updateLabelTranslation(x, y)
    ...
    #         if direction == 'Left':
    #             print('left')
    #             self.window.addRotation(int(value))
    #             # print(self.window.getRotation())
    #             # print(math.radians(self.window.getRotation()))
    #             b = self.window.getRotation()
    #             theta = str(b)
